...
const GridItem = ({ items }) => {
  ...
  return (
      ...
      <div className="griditem-sm w-[250px] h-[190px] border-[#D6DDEB] border-2 p-2 hover:bg-secondary hover:rounded-lg ease-in-out hover:text-slate-50 flex flex-col gap-3 justify-center items-start pl-5" onClick={handleClick}>
