...
const GridItem = ({ items }) => {
  ...
  return (
    <Link to={`/talent/search?position=${title}`}>
      <div className="griditem-sm w-[250px] h-[190px] border-[#D6DDEB] border-2 p-2 hover:bg-secondary hover:delay-100 ease-in-out hover:text-slate-50 flex flex-col gap-3 justify-center items-start pl-5">
